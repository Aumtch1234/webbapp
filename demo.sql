...
(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '$2y$10$qLqsIk0GgTHIvea9feZk7.QLPNWv2pxAgVG9y94YbaEPM6UG01mYS', '1', NULL, 'President'),
(1056, 'Patterson', 'Mary', 'x4611', 'mpatterso@classicmodelcars.com', '$2y$10$T/vsFMCVZO8fi16NQL9XaerJmcg5qutIDRhp7eVLEs637QTxcJq7y', '1', 1002, 'VP Sales'),
...
--
-- Table structure for table `new_productlines`
--
...
--
-- Dumping data for table `new_productlines`
--

INSERT INTO `new_productlines` (`productLine`, `textDescription`, `htmlDescription`, `image`) VALUES
('bicycle', 'จักยาน stryder นะ', 'https://stryderbikes.com/cdn/shop/files/ZeetaMaxElectricBlue.jpg?v=1688558406', 'https://stryderbikes.com/cdn/shop/files/ZeetaMaxElectricBlue.jpg?v=1688558406'),
('Trucks and Buses', 'The Truck and Bus models are realistic replicas of buses and specialized trucks produced from the early 1920s to present. The models range in size from 1:12 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. Materials used include tin, diecast and plastic. All models include a certificate of authenticity from their manufacturers and are a perfect ornament for the home and office.', '', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSExlAc_EDmkmi5UhoA3QdhDYGakCTSlyKQWg&s');
...
INSERT INTO `new_products` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES
...
('Hybrid car', 'Hybrid Electric Vehicle (HEV) quite simply', NULL, NULL),
...
--
-- Indexes for table `new_productlines`
--
ALTER TABLE `new_productlines`
...
--
ALTER TABLE `new_products`
  ADD CONSTRAINT `new_products_ibfk_1` FOREIGN KEY (`productLine`) REFERENCES `new_productlines` (`productLine`) ON DELETE CASCADE ON UPDATE CASCADE;
